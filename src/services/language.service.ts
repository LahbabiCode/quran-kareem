...
export class LanguageService {
  private translations: { [key: string]: { [key: string]: string } } = {
    ar: {
      ...
      // Footer translations
      'platform.name': 'القرآن الكريم',
      'platform.tagline': 'منصة قرآنية شاملة',
      'footer.description': 'منصة شاملة للقرآن الكريم تقدم تجربة تفاعلية غنية للمسلمين حول العالم. اقرأ، استمع، وتدبر كلام الله الكريم مع مجموعة واسعة من القراء والخدمات الإسلامية.',
      'footer.surahs': 'سورة',
      'footer.verses': 'آية',
      'footer.quickLinks': 'روابط سريعة',
      'footer.islamicServices': 'الخدمات الإسلامية',
      'footer.connect': 'تواصل ودعم',
      'footer.language': 'اختر اللغة',
      'footer.followUs': 'تابعنا على',
      'footer.getApp': 'حمّل التطبيق',
      'footer.downloadOn': 'حمّل من',
      'footer.getItOn': 'احصل عليه من',
      'footer.support': 'الدعم والمساعدة',
      'footer.helpCenter': 'مركز المساعدة',
      'footer.reportIssue': 'بلاغ عن مشكلة',
      'footer.feedback': 'اقتراحاتك تهمنا',
      'footer.copyright': '© جميع الحقوق محفوظة',
      'footer.allRightsReserved': 'جميع الحقوق محفوظة',
      'footer.madeWith': 'صُنع بـ',
      'footer.forUmmah': 'للأمة الإسلامية',
    ...
    en: {
      ...
      // Footer translations
      'platform.name': 'Quran Kareem',
      'platform.tagline': 'Comprehensive Quranic Platform',
      'footer.description': 'A comprehensive platform for the Holy Quran providing rich interactive experience for Muslims worldwide. Read, listen, and contemplate the word of Allah with a wide range of reciters and Islamic services.',
      'footer.surahs': 'Surahs',
      'footer.verses': 'Verses',
      'footer.quickLinks': 'Quick Links',
      'footer.islamicServices': 'Islamic Services',
      'footer.connect': 'Connect & Support',
      'footer.language': 'Choose Language',
